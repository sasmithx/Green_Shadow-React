                ...
                <form id="staffForm">
                    <div className="form-section">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                <label htmlFor="addressLine1">Address Line 1</label>
                                <input type="text" className="form-control" id="addressLine1" name="addressLine1" required value={staff?.addressLine1 || ''} style={inputStyle} onChange={handleChange} />
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-md-3 mb-3">
                                <label htmlFor="addressLine2">Address Line 2</label>
                                <input type="text" className="form-control" id="addressLine2" name="addressLine2" required value={staff?.addressLine2 || ''} style={inputStyle} onChange={handleChange} />
                            </div>
                            <div className="col-md-3 mb-3">
                                <label htmlFor="addressLine3">Address Line 3</label>
                                <input type="text" className="form-control" id="addressLine3" name="addressLine3" required value={staff?.addressLine3 || ''} style={inputStyle} onChange={handleChange} />
                            </div>
                            <div className="col-md-3 mb-3">
                                <label htmlFor="addressLine4">Address Line 4</label>
                                <input type="text" className="form-control" id="addressLine4" name="addressLine4" required value={staff?.addressLine4 || ''} style={inputStyle} onChange={handleChange} />
                            </div>
                            <div className="col-md-3 mb-3">
                                <label htmlFor="addressLine5">Address Line 5</label>
                                <input type="text" className="form-control" id="addressLine5" name="addressLine5" required value={staff?.addressLine5 || ''} style={inputStyle} onChange={handleChange} />
                            </div>
                        </div>
                    </div>
                    <div className="form-section">
                        ...
                        <div className="row">
                            <div className="col-md-2 mb-3">
                                <label htmlFor="members">Members</label>
                                <input type="number" className="form-control" id="members" name="members" style={inputStyle} value={staff?.members || ''} onChange={handleChange} />
                            </div>
                        </div>
                    </div>
                    <div className="row mt-3 mb-4">
