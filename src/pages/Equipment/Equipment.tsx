                ...
                <form id="equipmentForm">
                    <div className="row">
                        <div className="col-md-3">
                            ...
                            <input type="text" className="form-control" style={{ backgroundColor: "#558e55" }} id="equipmentId" name="equipmentId" required onChange={handleChange} />
                        </div>
                        <div className="col-md-3">
                            <label htmlFor="name1">Name</label>
                            <input type="text" className="form-control" style={{ backgroundColor: "#558e55" }} id="name1" name="name" required onChange={handleChange} />
                        </div>
                        <div className="col-md-2">
                            <label htmlFor="type">Type</label>
                            <select className="form-control" style={{ backgroundColor: "#558e55" }} id="type" name="type" required onChange={handleChange}>
                        ...
                        <div className="col-md-2">
                            ...
                            <select className="form-control" style={{ backgroundColor: "#558e55" }} id="status1" name="status" required onChange={handleChange}>
                        ...
                        <div className="col-md-2">
                            ...
                            <input type="number" className="form-control" style={{ backgroundColor: "#558e55" }} id="quantity" name="equantity" required onChange={handleChange} />
                        </div>
                    </div>
                    ...
                    <div className="row mt-3">
                        <div className="col-md-3">
                            ...
                            <select className="form-control" style={{ backgroundColor: "#558e55" }} id="assignedStaffId" name="assignedStaffId" required onChange={handleChange}>
                            </select>
                        </div>
                        <div className="col-md-3">
                            <label htmlFor="assignedFieldCode">Assigned Field Code</label>
                            <select className="form-control" style={{ backgroundColor: "#558e55" }} id="assignedFieldCode" name="assignedFieldCode" required onChange={handleChange}>
                            </select>
                        </div>
